...
TARGET_OPTIONS="$(docker_options.sh TARGET $TARGET_DOCKER_REPOSITORY $DOCKER_USERNAME $TARGET_TAG_PREFIX)"
SOURCE_OPTIONS="$(docker_options.sh SOURCE $SOURCE_DOCKER_REPOSITORY $DOCKER_USERNAME $SOURCE_TAG_PREFIX)"
